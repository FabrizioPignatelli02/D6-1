...
const concatenare = function (string1, string2)
{
  const startString = string1.slice(0,2);
...
const functionArrayNumbers = function()
{
  const numbers = [];
  for (let i=0; i<10; i++)
  {
...
const prova = functionArrayNumbers();

console.log("Es.2:", prova);
...
console.log("Es.3:", pariArray(prova));
...
const newMillenialFilms = function(array)
{
  const newArrayMillenial = array.filter((array) => (array.Year > 2000));
  return newArrayMillenial;
}

console.log("Es.12:", newMillenialFilms(movies));
